...
public class UISellList : MonoBehaviour
{
...
//			int index = GameProfile.SharedInstance.CharacterOrder[i];
	...
	private void OnPurchaseYes()
	{
		...
		characterToPurchase.Refresh();									// ask cell to update its GUI rendering to match data, in case it was updated in the transaction		
